...
// ventana emergente
document
  .getElementById("mostrarVentanaEmergente")
  .addEventListener("click", function () {
    document.getElementById("ventanaEmergente").style.display = "block";
  });

document
  .getElementById("cerrarVentanaEmergente")
  .addEventListener("click", function () {
    document.getElementById("ventanaEmergente").style.display = "none";
  });
// ventana emergente2
document
  .getElementById("mostrarVentanaEmergente2")
  .addEventListener("click", function () {
    document.getElementById("ventanaEmergente2").style.display = "block";
  });

document
  .getElementById("cerrarVentanaEmergente2")
  .addEventListener("click", function () {
...
function showPage(action) {
  ...
  if (action === 1 && curPage == pages.length - 1) {
    alert("Gracias por completar el Formulario. Descargue su Qr");
  }
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  nextButton.addEventListener("click", function () {
    if (currentPage === formPages.length - 2) {
      alerta();
    }
  ...
  function alerta() {
    ...
    // Agrega un temporizador para ocultar la alerta después de un cierto tiempo (por ejemplo, 3 segundos)
    setTimeout(function() {
